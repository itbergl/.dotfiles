return {
	...
	config = function()
		...
		keymap.set("n", "<leader>fp", require("telescope.builtin").builtin, { desc = "Search Builtin Pickers" })
		keymap.set("n", "<leader>fj", require("telescope.builtin").jumplist, { desc = "Search Jumplist" })
		keymap.set("n", "<leader>:", require("telescope.builtin").commands, { desc = "Search Commands" })
